...
<body>
    ...
    <br>
       ...
       <strong><h1 class="fw-bolder text-center" style="color:rgb(80, 197, 255)">Download Reports</h1></strong>
      ...
      <!-- language selection -->
        ...
        <a class="nav-link dropdown-toggle" href="#" role="button"
          ...
          <li><a class="dropdown-item" href="source-ita/DownloadPage.php">Italiano</a></li>
          </ul>
        </div>
        <br><br>
    ...
    <div class="container" style= "background-color: rgb(204, 247, 247); ; border: 2px solid black;">
      ...
      <form action = "Download.php" style="text-align: center;font-size: medium;" method = "POST" name = "download">
              ...
              <h4 >What types of reports to download?</h4>
              <br><br>
              <label for="headache">Headache</label>
              <input type="radio" id="headache" name="type" value="headache"  checked>
              <br>
              <label for="digital"> Usage of digital devices</label>
              <input type="radio" id="digital" name="type" value="digital"/>
              <br>
              <label for="sleep"> Quality of the sleep</label>
              <input type="radio" id="sleep" name="type" value="sleep" />
              <br><br>

              <h4 >Choose the time period of the reports to download </h4>
              <br><br>
