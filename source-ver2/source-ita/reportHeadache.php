...
<head>
    ...
    <title>Visualizza registrazione mal di testa</title>
...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <strong><h1 class="fw-bolder text-center" style="color:rgb(80, 197, 255)">Visualizza registrazione mal di testa</h1></strong>
    ...
    if ($_SERVER["REQUEST_METHOD"] !="GET") { 
        ...
        $query = "SELECT starting_time, ending_time, ache_position, ache_intensity, ache_type,
         painkillers, repercussions, symptoms FROM headache where report_id= $1 ";
